...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> DEADWOOD_PLACED_KEY = registerKey("deadwood_placed");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, DEADWOOD_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.DEADWOOD_KEY),
                VegetationPlacedFeatures.treeModifiersWithWouldSurvive(
                        PlacedFeatures.createCountExtraModifier(2,0.1f,2), ModBlocks.DEADWOOD_SAPLING));
