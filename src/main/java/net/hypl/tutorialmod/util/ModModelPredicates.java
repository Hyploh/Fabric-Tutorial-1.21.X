package net.hypl.tutorialmod.util;
...
public class ModModelPredicates {
    public static void registerModelPredicates() {
        ...
        registerCustomBow(ModItems.HYPL_BOW);
    ...
    private static void registerCustomBow(Item item) {
        ModelPredicateProviderRegistry.register(item, Identifier.ofVanilla("pull"),
            ...
            if (entity == null) {
                ...
                return entity.getActiveItem() != stack ? 0.0F : (float)(stack.getMaxUseTime(entity) - entity.
                        getItemUseTimeLeft()) / 20.0F;
            }
        });
